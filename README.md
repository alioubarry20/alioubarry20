...
| Badge | Délivré |
|-------|---------|
| ✅ Introduction to Cybersecurity | Janv. 2026 |
| ✅ Networking Basics | Janv. 2026 |
| ✅ Network Addressing and Basic Troubleshooting | Mars 2026 |
| ✅ Networking Devices and Initial Configuration | 2026 |
...
|--------|-------------|-------|
| [ActiveDirectory](https://github.com/alioubarry20/ActiveDirectory) | Infra AD pour PME fictive — users, groupes, GPO | Windows Server |
| [HomeLabWazuh-kali](https://github.com/alioubarry20/HomeLabWazuh-kali) | HomeLab SIEM avec machine Kali vulnérable | Linux, Wazuh, DVWA |
| [PredictionMaladeIA](https://github.com/alioubarry20/PredictionMaladeIA) | IA de prédiction du diabète | Python, ML |
| [LaravelProjet](https://github.com/alioubarry20/LaravelProjet) | Gestion de bibliothèque (emprunts/retours) | Laravel, Blade |
